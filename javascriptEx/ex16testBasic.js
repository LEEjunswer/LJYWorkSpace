...
console.log(Math.random()* 10); // 0~9에서 랜덤값
console.log(Math.random() *100); // 0~99 // 1~ 100
console.log(Math.random() * 10 +1); //(0~9) +1 => 1~10 값
...
return cnt === arr.length ? '전부 홀수값입니다' : '홀수 값이 아닌게 있습니다'
}
