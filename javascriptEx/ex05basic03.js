...
console.log(num ==='10'); //값 + type을 비교한다
...
//  + : 1) 산술연산자로써 더하기 ,2)연결결연산자 3)부호로써 +

number = '10';  // 문자열은 그냥  뒤에 10이 붙는다
console.log(number + 10);  // 문자열은 그냥  뒤에 10이 붙는다.
console.log(+number +10);  //number앞에 +가 붙으면 숫자로 인식되어 더해진다 +는 부호로 인식
console.log(typeof + number); //+는 부호로 인식
...
//           : && 모든 비교연산자 중에 하나로도 거짓이면 거짓 => 한개가 거짓이면 나머지 비교 x 건너 뛴다
